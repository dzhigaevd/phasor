...
switch postPhasor.experiment.beamline
    ...
    case '34idc'        
        ...
        O.sampleVerticalAxisRotation = postPhasor.experiment.theta+postPhasor.experiment.theta_correction;
        O.sampleBeamAxisRotation = 90;
        O.sampleHorizontalAxisRotation = postPhasor.experiment.phi+postPhasor.experiment.phi_correction;
    case 'nanomax'
        % beamline detector motor angles in degrees
        ...
        O.sampleVerticalAxisRotation = postPhasor.experiment.gonphi+postPhasor.experiment.phi_correction;
        O.sampleBeamAxisRotation = 90;
        O.sampleHorizontalAxisRotation = postPhasor.experiment.gontheta+postPhasor.experiment.theta_correction;
    ...
    case 'p10'
        ...
        O.sampleVerticalAxisRotation = postPhasor.experiment.phi+postPhasor.experiment.phi_correction;
        O.sampleBeamAxisRotation = 90;
        O.sampleHorizontalAxisRotation = postPhasor.experiment.omega+postPhasor.experiment.omega_correction;
end                               
