...
% close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Adapted by D. Dzhigaev, Lund Univerity 2020
...
O.d = postPhasor.experiment.detector_pitch; % detector pixel size in m--this is effective, becomes larger than actual if binning is used
...
%     save([save_dir, '/', save_name,'_(', num2str(O.hkl(1)), num2str(O.hkl(2)), num2str(O.hkl(3)),')_', num2str(O.gamma_bl),'_gamma_',num2str(O.delta_bl),'_delta_',num2str(O.rocking_increment),'_',O.rocking_angle, '-SAM.mat'], 'array','pitch_array');
% end
