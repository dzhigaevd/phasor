...
O.theta_bl = postPhasor.experiment.phi;
O.chi_bl   = postPhasor.experiment.chi;
O.phi_bl   = postPhasor.experiment.theta;

% beamline detector motor angles in degrees
O.delta_bl = postPhasor.experiment.gamma;
...
O.N = size(postPhasor.object,1); % number of pixels along each dimension of square detector and rocking curve
